...
export default class OutlinePass extends Pass {
	constructor (resolution, scene, camera, selectedObjects = []) {
		...
		// replace depth to view Z
		this.prepareMaskMaterial.fragmentShader = this.prepareMaskMaterial.fragmentShader.replace(/DEPTH_TO_VIEW_Z/g, cameraType + 'DepthToViewZ')
	...
	changeVisibilityOfSelectedObjects (bVisible) {
		// gather selected meshes callBack
	...
	render (renderer, writeBuffer, readBuffer, deltaTime, maskActive) {
		if (this.selectedObjects.length > 0) {
			...
			this.prepareMaskMaterial.uniforms['cameraNearFar'].value = new Vector2(this.camera.near, this.camera.far)
